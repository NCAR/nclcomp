...
coerce_missing
coerce_input_double
coerce_subset_input_double_step
coerce_output_float_or_double_step
coerce_input_double
coerce_subset_input_double_step
_Nclcoerce
*/
...
/*
void _ncomp_coerce_to_double(void* arr, int arr_type, void* arr_missing, double* out_arr, double* out_missing, size_t arr_size) {
    long i;
        ...
        case NCOMP_BYTE:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((signed char*)arr)[i] == *((signed char*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((signed char*)arr)[i];
                }
            }
            break;
        case NCOMP_UBYTE:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned char*)arr)[i] == *((unsigned char*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((unsigned char*)arr)[i];
                }
            }
            break;
        case NCOMP_SHORT:
        ...
        case NCOMP_USHORT:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned short*)arr)[i] == *((unsigned short*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((unsigned short*)arr)[i];
                }
            }
            break;
        case NCOMP_INT:
        ...
        case NCOMP_UINT:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned int*)arr)[i] == *((unsigned int*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((unsigned int*)arr)[i];
                }
            }
            break;
        case NCOMP_LONG:
        ...
        case NCOMP_ULONG:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned long*)arr)[i] == *((unsigned long*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((unsigned long*)arr)[i];
                }
            }
            break;
        case NCOMP_LONGLONG:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((long long*)arr)[i] == *((long long*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((long long*)arr)[i];
                }
            }
            break;
        case NCOMP_ULONGLONG:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned long long*)arr)[i] == *((unsigned long long*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((unsigned long long*)arr)[i];
                }
            }
            break;
        case NCOMP_LONGDOUBLE:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((long double*)arr)[i] == *((long double*)arr_missing)) {
                    ...
                    out_arr[i] = (double)((long double*)arr)[i];
                }
            }
            break;
    }
...
void _ncomp_coerce_to_float(void* arr, int arr_type, void* arr_missing, float* out_arr, float* out_missing, size_t arr_size) {
    long i;
    int arr_has_missing = 0;
        ...
        case NCOMP_BYTE:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((signed char*)arr)[i] == *((signed char*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((signed char*)arr)[i];
                }
            }
            break;
        case NCOMP_UBYTE:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned char*)arr)[i] == *((unsigned char*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((unsigned char*)arr)[i];
                }
            }
            break;
        case NCOMP_SHORT:
        ...
        case NCOMP_USHORT:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned short*)arr)[i] == *((unsigned short*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((unsigned short*)arr)[i];
                }
            }
            break;
        case NCOMP_INT:
        ...
        case NCOMP_UINT:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned int*)arr)[i] == *((unsigned int*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((unsigned int*)arr)[i];
                }
            }
            break;
        case NCOMP_LONG:
        ...
        case NCOMP_ULONG:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned long*)arr)[i] == *((unsigned long*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((unsigned long*)arr)[i];
                }
            }
            break;
        case NCOMP_LONGLONG:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((long long*)arr)[i] == *((long long*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((long long*)arr)[i];
                }
            }
            break;
        case NCOMP_ULONGLONG:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((unsigned long long*)arr)[i] == *((unsigned long long*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((unsigned long long*)arr)[i];
                }
            }
            break;
        case NCOMP_LONGDOUBLE:
            for (i = 0; i < arr_size; i++) {
                if (arr_has_missing && ((long double*)arr)[i] == *((long double*)arr_missing)) {
                    ...
                    out_arr[i] = (float)((long double*)arr)[i];
                }
            }
            break;
    }
